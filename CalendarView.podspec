...
Pod::Spec.new do |s|
  ...
  s.name         = "CalendarView"
  s.version      = "0.0.1"
  s.summary      = "A simple use for ios calendar."
  ...
  # Or just: s.author    = "Light413"
  # s.authors            = { "Light413" => "18016373660@163.com" }
  # s.social_media_url   = "http://twitter.com/Light413"
  ...
  s.source_files  = "calendar/CalendarView/*.{h,m}"
